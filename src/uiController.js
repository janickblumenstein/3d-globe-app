...
// In uiController.js oder main.js
function populateMetricsDropdown(dataManager) {
    const select = document.getElementById('metric-selector');
    select.innerHTML = ''; // Vorherige Optionen löschen

    dataManager.availableMetrics.forEach(metricKey => {
        const meta = dataManager.dataset.metrics_metadata[metricKey];
        const option = document.createElement('option');
        option.value = metricKey;
        option.textContent = meta.name; // z.B. "Kinder pro Familie"
